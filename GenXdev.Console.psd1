...
RequiredModules = @(@{ModuleName = 'PSReadLine'; ModuleVersion = '2.3.6'; }, 
               @{ModuleName = 'GenXdev.Webbrowser'; ModuleVersion = '1.270.2025'; })
...
AliasesToExport = '..', '...', '....', '.....', '......', 'addtoplaylist', 'audiofeatures', 
               'dislike', 'findmedia', 'fm', 'fmp', 'fmq', 'fvlc', 'gcp', 'getplaylist', 
               'gettrack', 'gupl', 'iss', 'like', 'liked', 'lyrics', 'media', 'monitoroff', 
               'moveliked', 'newplaylist', 'next', 'norepeat', 'noshuffle', 'pausemusic', 
               'play', 'poweroff', 'prev', 'previous', 'removefromplaylist', 'repeat', 
               'repeatoff', 'repeatsong', 'say', 'showvlc', 'shuffle', 'shuffleoff', 
               'shuffleon', 'skip', 'sm', 'smp', 'smq', 'spld', 'sst', 'startmusic', 'stop', 
               'togglepausemusic', 'vlc', 'vlcback', 'vlcf', 'vlclyrics', 'vlcmedia', 
               'vlcmute', 'vlcnext', 'vlcpause', 'vlcplay', 'vlcprev', 'vlcrepeat', 
               'vlcunmute', 'wakemonitor', 'x'
