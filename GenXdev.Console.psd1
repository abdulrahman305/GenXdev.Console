...
@{
  ...
  RequiredModules      = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.80.2024' }, @{ModuleName = 'GenXdev.Webbrowser'; ModuleVersion = '1.80.2024' }, @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion = '1.80.2024' });

  # Assemblies that must be loaded prior to importing this module
  RequiredAssemblies   = @(
    ".\\lib\\System.Management.Automation.dll",
    ".\\lib\\GenXdev.Console.dll"
  )
  ...
  ".\\lib\\GenXdev.Console.deps.json",
  ".\\lib\\GenXdev.Console.dll",
  ".\\lib\\GenXdev.Console.pdb",
