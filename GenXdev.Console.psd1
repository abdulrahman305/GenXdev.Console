...
@{
    ...
    RequiredModules        = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion  = '1.29.2021'}, @{ModuleName = 'GenXdev.Webbrowser'; ModuleVersion  = '1.29.2021'}, @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion  = '1.29.2021'});
    ...
    PrivateData            = @{
        ...
        PSData = @{
            ...
            LicenseUri               = 'https://raw.githubusercontent.com/renevaessen/GenXdev.Console/main/LICENSE'

            # A URL to the main website for this project.
            ProjectUri               = 'https://github.com/renevaessen/GenXdev.Console'
