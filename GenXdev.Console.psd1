...
@{
    ...
    RequiredModules      = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.62.2024' }, @{ModuleName = 'GenXdev.Webbrowser'; ModuleVersion = '1.62.2024' }, @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion = '1.62.2024' });

    # Assemblies that must be loaded prior to importing this module
    RequiredAssemblies   = @(
      ".\\dependencies\\System.Management.Automation.dll",
      ".\\dependencies\\GenXdev.Console.dll"
    )
  ...
  ".\\dependencies\\GenXdev.Console.deps.json",
  ".\\dependencies\\GenXdev.Console.dll",
  ".\\dependencies\\GenXdev.Console.pdb",
