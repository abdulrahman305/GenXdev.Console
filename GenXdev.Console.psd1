...
RequiredModules = @(@{ModuleName = 'PSReadLine'; ModuleVersion = '2.3.6'; }, 
               @{ModuleName = 'GenXdev.Webbrowser'; ModuleVersion = '1.302.2025'; })
...
CmdletsToExport = 'Add-SpotifyNewPlaylist', 'Add-SpotifyTracksToLiked', 
               ...
               'Set-TextToSpeechStopped', 'Set-VLCPlayerFocused', 
...
AliasesToExport = 'addtoplaylist', 'audiofeatures', 'dislike', 'findmedia', 'fm', 'fmp', 'fmq', 
               ...
               'removefromplaylist', 'repeat', 'repeatoff', 'repeatsong', 'say', 
               'Set-TextToSpeechStopped', 'showvlc', 'shuffle', 'shuffleon', 'skip', 'sm', 
               'smp', 'smq', 'snake', 'spld', 'sst', 'startmusic', 'stop', 'togglepausemusic', 
               'vlc', 'vlcback', 'vlcf', 'vlclyrics', 'vlcmedia', 'vlcmute', 'vlcnext', 
               'vlcpause', 'vlcplay', 'vlcprev', 'vlcrepeat', 'vlcunmute', 'wakemonitor', 
               'x'
...
FileList = '.gitignore', 'GenXdev.Console-Help.xml', 'GenXdev.Console.csproj', 
               'GenXdev.Console.psd1', 'GenXdev.Console.psm1', 
               'GenXdev.Console.Spotify.psm1', 'GenXdev.Console.Vlc.psm1', 'LICENSE', 
               'powershell.jpg', 'README.md', 'lib\GenXdev.Console.deps.json', 
               ...
               'Functions\GenXdev.Console\Set-TextToSpeechStopped.cs', 
