...
@{
    ...
    RequiredModules      = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.60.2024' }, @{ModuleName = 'GenXdev.Webbrowser'; ModuleVersion = '1.60.2024' }, @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion = '1.60.2024' });
